...
export const WeatherProvider = (props) => {
    ...
    const getEventWeather = (event) => {
        return fetch(`http://api.openweathermap.org/data/2.5/forecast?zip=${parseInt(event.eventZip)},us&appid=${defaultExport.weatherKey}&units=imperial`)
        .then(response => response.json())
